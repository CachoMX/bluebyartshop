          ...
          <AnimateIn direction="right" className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-3">
                {/* Facebook */}
                <a href="#" title="Facebook" className="w-11 h-11 rounded-2xl flex items-center justify-center transition-transform hover:scale-110" style={{ backgroundColor: "#1877F2" }}>
                ...
                {/* Instagram */}
                <a href="#" title="Instagram" className="w-11 h-11 rounded-2xl flex items-center justify-center transition-transform hover:scale-110"
                ...
                {/* TikTok */}
                <a href="#" title="TikTok" className="w-11 h-11 rounded-2xl flex items-center justify-center transition-transform hover:scale-110" style={{ backgroundColor: "#010101" }}>
                ...
                {/* YouTube */}
                <a href="#" title="YouTube" className="w-11 h-11 rounded-2xl flex items-center justify-center transition-transform hover:scale-110" style={{ backgroundColor: "#FF0000" }}>
