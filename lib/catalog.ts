...
export const subscriptionTiers: SubscriptionTier[] = [
  {
    ...
    schemaDescription:
      "Monthly art kit for kids ages 5-7. Includes 2 plaster figures or 10 coloring pages, 6 non-toxic paint pots, brush, step-by-step instructions, and sticker sheet. Cancel anytime.",
    suggestedMinAge: 5,
    suggestedMaxAge: 7,
  },
  {
    ...
    popular: true,
    description:
      "Our most popular tier - packed with variety for growing artists.",
    features: [
    ...
    schemaDescription:
      "Most popular monthly art kit for kids ages 5-12. Includes 3 plaster figures or 20 coloring pages, 1 mini 3D print, 12 paint pots, brush set, sealant, activity card, and digital banner template. Cancel anytime.",
    suggestedMinAge: 5,
    suggestedMaxAge: 12,
  },
  {
    ...
    popular: false,
    description:
      "The ultimate kit for serious young artists who create and share.",
    features: [
    ...
    schemaDescription:
      "Premium monthly art kit for kids ages 5-12. Includes 4 plaster figures or 30 coloring pages, 2 mini 3D prints, 18 paint pots with metallics, illustrated storybook, display stand, and resell kit. Cancel anytime.",
    suggestedMinAge: 5,
    suggestedMaxAge: 12,
  },
];
