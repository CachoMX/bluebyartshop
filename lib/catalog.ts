...
// ── Real Mini Art Kits (linked to WooCommerce store) ──────────────────────
// 9 themed plaster paint kits @ $29.99. Each has 6 plaster figurines, 3 paints, 1 brush, stickers + instructions.
// Real product images generated and verified for ASTM D-4236 compliance.

const miniKitFeatures = (theme: string) => [
  `6 pre-molded ${theme} plaster figurines, ready to paint`,
  "3 non-toxic acrylic paint pots in faithful theme colors",
  "1 child-safe blue paint brush",
  "2 themed sticker sheets",
  "Step-by-step illustrated instruction card",
  "ASTM D-4236 compliant — safe for ages 4 and up",
  "Presented in our signature kraft + Blueby gift box",
];

const miniKitDescription = (theme: string, pieces: string) =>
  `Paint your own plaster ${theme} pieces with this themed art kit from ${BRAND_NAME}. Each kit includes ${pieces}, 3 non-toxic acrylic paint pots, 1 child-safe brush, 2 sticker sheets and a step-by-step instruction card — all presented in our signature gift box. Plaster pieces are flat-backed bas-reliefs, so they lie flat on the table for easy painting by little hands. Designed for kids ages 4 and up. ASTM D-4236 compliant.`;

export const catalogProducts: CatalogProduct[] = [
  {
    id: 101,
    slug: "bear-mini-art-kit",
    name: "Bear Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/bear-empaque.webp",
    gradientFrom: "#D6E9F8",
    gradientTo: "#B5D4F0",
    emoji: "🐻",
    badge: "Bestseller",
    shortDesc: "Bear, turtle, Earth and stars — paint your own.",
    description: miniKitDescription("bear-themed", "a bear, a turtle, an Earth globe and 2 stars"),
    features: miniKitFeatures("bear-themed"),
    relatedSlugs: ["animal-mini-art-kit", "dino-mini-art-kit", "farm-mini-art-kit"],
  },
  {
    id: 102,
    slug: "bee-mini-art-kit",
    name: "Bee Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/bee-empaque.webp",
    gradientFrom: "#FFF4CC",
    gradientTo: "#FFE799",
    emoji: "🐝",
    badge: "New",
    shortDesc: "Bumblebee, honeycomb and roses — sweet to paint.",
    description: miniKitDescription("bee-themed", "a bumblebee, a honeycomb hexagon and 4 roses"),
    features: miniKitFeatures("bee-themed"),
    relatedSlugs: ["garden-mini-art-kit", "farm-mini-art-kit", "animal-mini-art-kit"],
  },
  {
    id: 103,
    slug: "boat-mini-art-kit",
    name: "Boat Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/boat-empaque.webp",
    gradientFrom: "#CCE5FF",
    gradientTo: "#A0CFFF",
    emoji: "⛵",
    badge: null,
    shortDesc: "Sailboat, koala, gorilla and stars — set sail.",
    description: miniKitDescription("boat-themed", "a sailboat, a koala, a gorilla and 3 stars"),
    features: miniKitFeatures("boat-themed"),
    relatedSlugs: ["animal-mini-art-kit", "bear-mini-art-kit", "farm-mini-art-kit"],
  },
  {
    id: 104,
    slug: "christmas-mini-art-kit",
    name: "Christmas Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/christmas-empaque.webp",
    gradientFrom: "#FCD9D9",
    gradientTo: "#C8E6C9",
    emoji: "🎄",
    badge: "Popular",
    shortDesc: "Santa, stocking, gifts and a Christmas tree.",
    description: miniKitDescription("Christmas-themed", "a Santa head, a stocking, a gift box, a snowman, a gingerbread house and a Christmas tree"),
    features: miniKitFeatures("Christmas-themed"),
    relatedSlugs: ["halloween-mini-art-kit", "bear-mini-art-kit", "farm-mini-art-kit"],
  },
  {
    id: 105,
    slug: "dino-mini-art-kit",
    name: "Dino Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/dino-empaque.webp",
    gradientFrom: "#D4EDDA",
    gradientTo: "#B8DFBE",
    emoji: "🦕",
    badge: "Bestseller",
    shortDesc: "T-Rex, triceratops, brontosaurus and friends.",
    description: miniKitDescription("dinosaur-themed", "a T-Rex, a triceratops, a brontosaurus, a stegosaurus, an ankylosaurus and a pterodactyl"),
    features: miniKitFeatures("dinosaur-themed"),
    relatedSlugs: ["animal-mini-art-kit", "bear-mini-art-kit", "halloween-mini-art-kit"],
  },
  {
    id: 106,
    slug: "farm-mini-art-kit",
    name: "Farm Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/farm-empaque.webp",
    gradientFrom: "#FFE4C4",
    gradientTo: "#FFD3A0",
    emoji: "🚜",
    badge: null,
    shortDesc: "Pumpkin, barn, scarecrow and harvest fun.",
    description: miniKitDescription("farm-themed", "a pumpkin, a basket of corn, a leaf, a barn, a scarecrow and a carrot"),
    features: miniKitFeatures("farm-themed"),
    relatedSlugs: ["halloween-mini-art-kit", "garden-mini-art-kit", "bear-mini-art-kit"],
  },
  {
    id: 107,
    slug: "garden-mini-art-kit",
    name: "Garden Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/garden-empaque.webp",
    gradientFrom: "#FFD6E0",
    gradientTo: "#FFC8D3",
    emoji: "🌸",
    badge: "New",
    shortDesc: "Butterfly, ladybug and a flower bouquet.",
    description: miniKitDescription("garden-themed", "a butterfly, a ladybug dome, 3 roses and 2 daisies"),
    features: miniKitFeatures("garden-themed"),
    relatedSlugs: ["bee-mini-art-kit", "farm-mini-art-kit", "animal-mini-art-kit"],
  },
  {
    id: 108,
    slug: "halloween-mini-art-kit",
    name: "Halloween Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/halloween-empaque.webp",
    gradientFrom: "#FFD8B5",
    gradientTo: "#FFB36F",
    emoji: "🎃",
    badge: "Popular",
    shortDesc: "Witch-pumpkin, bat, ghost and stars.",
    description: miniKitDescription("Halloween-themed", "a witch-pumpkin with hat, a bat, a ghost and 3 stars"),
    features: miniKitFeatures("Halloween-themed"),
    relatedSlugs: ["christmas-mini-art-kit", "dino-mini-art-kit", "animal-mini-art-kit"],
  },
  {
    id: 109,
    slug: "animal-mini-art-kit",
    name: "Animal Mini Art Kit",
    price: 29.99,
    category: "plaster",
    age: "5-7",
    minAge: 4,
    maxAge: 8,
    image: "/images/products/animal-empaque.webp",
    gradientFrom: "#FFF0CC",
    gradientTo: "#FFE099",
    emoji: "🦁",
    badge: "Bestseller",
    shortDesc: "Snail, koala, butterfly, rose, lion and hippo.",
    description: miniKitDescription("animal-themed", "a snail, a sitting koala, a butterfly, a rose, a sitting lion and a hippo"),
    features: miniKitFeatures("animal-themed"),
    relatedSlugs: ["bear-mini-art-kit", "dino-mini-art-kit", "garden-mini-art-kit"],
  },
  {
    id: 1,
